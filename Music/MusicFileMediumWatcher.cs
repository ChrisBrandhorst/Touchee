...
namespace Music {
    ...
    public class MusicFileMediumWatcher : FileMediumWatcher<MusicDirectoryWatcher> {
        ...
        // 
        //Dictionary<Medium, MasterPlaylist> _masters = new Dictionary<Medium, MasterPlaylist>();
        ...
        protected override void OnWatch(Medium medium) {
            ...
            //_masters[medium] = masterPlaylist;
        ...
        /// <summary>
        /// When a medium is unwatch, we dispose of all the playlists and tracks from that medium
        /// </summary>
