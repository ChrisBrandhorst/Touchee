...
namespace ListenLive {
    ...
    /// </remarks>
    public class Plugin : Base, IPlugin, IMediumWatcher, IContentProvider {
        ...
        /// </summary>
        public string Name { get { return "ListenLive.eu"; } }


        /// <summary>
        /// The description of this plugin
        /// </summary>
        public string Description { get { return "Content provider for web radio streams listen on ListenLive.eu - Netherlands."; } }
        ...
        /// <summary>
        /// Whether this plugin provides a custom frontend
        /// </summary>
        ...
        /// <param name="filter">The filter object which contains the parameters with which to query for items</param>
        /// <returns>The results</returns>
        public Contents GetContent(IContainer container, Options filter) {
            var channels = GetChannels(container, filter);
