...
namespace Touchee.Playback {
    ...
    /// </remarks>
    public class OQueue : Collectable<OQueue> {
        ...
        public OQueue(string contentType) {
        ...
        /// <param name="contentType">The content type of the items in the queue</param>
        public OQueue(IItem item, string contentType) : this(contentType) {
        ...
        /// <param name="contentType">The content type of the items in the queue</param>
        public OQueue(IEnumerable<IItem> items, string contentType) : this(contentType) {
    ...
    public delegate void QueueItemsUpdatedEventHandler(OQueue queue);
    public delegate void QueueIndexChangedEventHandler(OQueue queue, IItem previous, IItem current);
    public delegate void QueueFinishedEventHandler(OQueue queue);
